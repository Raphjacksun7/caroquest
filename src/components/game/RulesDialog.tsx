...
export const RulesDialog = ({ isOpen, onClose, pawnsPerPlayer }: RulesDialogProps) => {
        ...
        <Tabs defaultValue="basics" className="w-full">
          ...
          <TabsContent value="visuals" className="space-y-4 text-sm">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-4 gap-y-2">
                  ...
                  <div className="flex items-center gap-2">
                      <div className="w-5 h-5 rounded-full bg-[hsl(var(--player1-pawn-color))] border-4 border-[hsl(var(--highlight-creating-dead-zone-pawn-border))] relative">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-zap text-white absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2"><polygon points="13 2 3 14 12 14 11 22 21 10 12 10 13 2"/></svg>
