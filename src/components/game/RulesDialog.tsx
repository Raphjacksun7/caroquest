      ...
      <Tabs defaultValue="basics" className="w-full">
        ...
        <TabsContent value="basics" className="space-y-4 text-sm">
          ...
          <ul className="list-disc ml-5 space-y-1">
            <li>
              <strong>{t("rulesPlacementPhase")}</strong>{" "}
              {t("rulesPlacementDescription")}
            </li>
            <li>
              <strong>{t("rulesMovementPhase")}</strong>{" "}
              {t("rulesMovementDescription")}
            </li>
          </ul>
        </TabsContent>
        ...
        <TabsContent value="visuals" className="space-y-4 text-sm">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-4 gap-y-3">
            <div className="flex items-center gap-2">
              <div className="w-5 h-5 rounded-full bg-[hsl(var(--player1-pawn-color))] border-2 border-opacity-75 border-[hsl(var(--player1-pawn-color))]"></div>{" "}
              {t("player1Pawn")}
            </div>
            <div className="flex items-center gap-2">
              <div className="w-5 h-5 rounded-full bg-[hsl(var(--player2-pawn-color))] border-2 border-opacity-75 border-[hsl(var(--player2-pawn-color))]"></div>{" "}
              {t("player2Pawn")}
            </div>
            <div className="flex items-center gap-2">
            ...
            <div className="flex items-center gap-2">
              ...
              {t("pawnCreatingDeadZone")}
            </div>
            <div className="flex items-center gap-2">
              <div className="w-5 h-5 rounded-full bg-[hsl(var(--player1-pawn-color))] border-4 border-[hsl(var(--highlight-selected-pawn))]"></div>{" "}
              {t("selectedPawn")}
            </div>
            <div className="flex items-center gap-2">
              <div className="w-5 h-5 rounded-full bg-[hsl(var(--player1-pawn-color))] border-4 border-[hsl(var(--highlight-win-line))] animate-pulse"></div>{" "}
              {t("winningPawn")}
            </div>
            <div className="flex items-center gap-2">
              <div className="w-5 h-5 bg-[hsl(var(--board-light-square))] flex items-center justify-center relative border border-muted">
                <div className="absolute inset-0 flex items-center justify-center text-[hsl(var(--highlight-dead-zone-marker))] opacity-50 text-2xl font-bold pointer-events-none">
                  ×
                </div>
              </div>{" "}
              {t("deadZoneSquare")}
